...
public class IncomeAddActivity extends AppCompatActivity {
    ...
    EntryTypesAPI.GetIncomeTypesCallBack incomeTypesCallBack = new EntryTypesAPI.GetIncomeTypesCallBack() {
        ...
        public void onResponse(boolean successful, String errorMsg, List<EntryType> incomeTypes) {
            ...
            if (successful) {
                spinnerArrayAdapter = new ArrayAdapter(IncomeAddActivity.this, android.R.layout.simple_spinner_item, incomeTypes.toArray());
            } else {
                spinnerArrayAdapter = new ArrayAdapter(IncomeAddActivity.this, android.R.layout.simple_spinner_item, new EntryType[0]);
            }
        ...
        public void onFailure(String cause) {
            Log.d("TAG", "It failed.");
            Toast.makeText(IncomeAddActivity.this, cause, Toast.LENGTH_LONG).show();
        }
    };
    EntriesAPI.InsertEntryCallBack insertEntryCallBack = new EntriesAPI.InsertEntryCallBack() {
        ...
        public void onResponse(boolean successful, String errorMsg, Entry entry) {
            if (successful) {
                Toast.makeText(IncomeAddActivity.this, "Entry successfully inserted", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(IncomeAddActivity.this, "Invalid entry!", Toast.LENGTH_SHORT).show();
            }
        }
